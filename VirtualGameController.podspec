...
s.homepage = 'https://github.com/jakubknejzlik/VirtualGameController'
s.author = { 'tadija' => 'john.doe@example.com' }
s.social_media_url = 'http://twitter.com/john.doe'

s.source = { :git => 'https://github.com/jakubknejzlik/VirtualGameController.git', :tag => String(s.version) }
