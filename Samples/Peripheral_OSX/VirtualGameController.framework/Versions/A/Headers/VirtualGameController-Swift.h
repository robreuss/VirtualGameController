...
@property (nonatomic, strong) NSColor * __null_unspecified backgroundColor;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithProfileType:(enum ProfileType)profileType backgroundColor:(NSColor * __nonnull)backgroundColor OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithCoder:(NSCoder * __nonnull)decoder;
@property (nonatomic, readonly, copy) NSString * __nonnull description;
- (void)encodeWithCoder:(NSCoder * __nonnull)coder;
